    ...
    <>
      <div className="w3-top">
        <div className="w3-bar w3-black w3-card w3-padding-10">
          ...
          &nbsp;&nbsp;
          <Link
            className="w3-bar-item w3-button w3-padding-medium w3-hide-small w3-right"
            to="/CartPage"
          >
            Cart
          </Link>
      ...
      <div
        id="navDemo"
        className="w3-bar-block w3-light-grey w3-hide w3-hide-large w3-hide-medium w3-top"
      >
        <Link
          className="w3-bar-item w3-button-2 w3-padding-xlarge"
          to="/AboutUs"
        >
          About Us
        </Link>
        ...
        <Link
          className="w3-bar-item w3-button-last w3-padding-xlarge"
          to="/CartPage"
        >
          Cart
        </Link>
